        ...
        <div className="relative flex items-center justify-between h-24">
          <div className="flex items-center justify-between w-full">
            ...
            <a
              target="_blank"
              href="/explore"
              className="flex mr-[calc(24px+16px)] sm:mr-0 justify-center space-x-2 items-center bg-black text-white border-primer rounded-lg pl-3 text-base font-bold h-10 sm:h-12 min-w-[105px] sm:min-w-[140px] transition-all"
              rel="noreferrer"
            >
