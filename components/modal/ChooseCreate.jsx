        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            <div className="flex min-h-full  items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl py-20 bg-black/60 border border-gray-400 p-6 text-left align-middle shadow-xl transition-all z-50">
                  <Dialog.Title
                    as="h3"
